...
export const OWNER_USERNAME = process.env.OWNER_USERNAME ?? "ca213bas@gmail.com";
const OWNER_PASSWORD_HASH = process.env.OWNER_PASSWORD_HASH ?? "$2b$12$m1pBNEr/VkEwEfg.qdXLNe/9BfEDZDTXzjE0/D.DOAV2McU/7Ityu";
