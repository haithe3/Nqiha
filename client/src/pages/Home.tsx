...
export default function Home() {
  ...
  const [bookingForm, setBookingForm] = useState({ customerName: "", phone: "", address: "", bookingDate: new Date().toISOString().slice(0, 10), bookingTime: "10:00", paymentMethod: "cash" as "cash" | "cib" | "baridimob" });
